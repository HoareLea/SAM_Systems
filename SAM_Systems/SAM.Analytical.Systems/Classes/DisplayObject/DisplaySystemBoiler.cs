...
{
    public class DisplaySystemBoiler : SystemBoiler, IDisplaySystemObject<SystemGeometryInstance>
    {
        ...
        public DisplaySystemBoiler(SystemBoiler systemBoiler, SystemGeometrySymbol systemGeometrySymbol, Point2D location)
            :base(systemBoiler)
        {
        ...
        public DisplaySystemBoiler(JsonObject jObject)
            : base(jObject)
        {
