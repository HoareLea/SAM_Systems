...
{
    public class DisplaySystemDifferenceController : SystemDifferenceController, IDisplaySystemObject<SystemGeometryInstance>
    {
        ...
        public DisplaySystemDifferenceController(JObject jObject)
            : base(jObject)
        {
