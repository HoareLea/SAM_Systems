...
namespace SAM.Analytical.Systems
{
    public class DisplaySystemMaxLogicalController : SystemMaxLogicalController, IDisplaySystemController
    {
        ...
        public DisplaySystemMaxLogicalController(SystemMaxLogicalController systemMaxLogicalController, SystemGeometrySymbol systemGeometrySymbol, Point2D location)
        ...
        public DisplaySystemMaxLogicalController(JsonObject jObject)
            : base(jObject)
        {
