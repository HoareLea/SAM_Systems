...
{
    public class DisplaySystemSurfaceWaterExchanger : SystemSurfaceWaterExchanger, IDisplaySystemObject<SystemGeometryInstance>
    {
        ...
        public DisplaySystemSurfaceWaterExchanger(SystemSurfaceWaterExchanger systemSurfaceWaterExchanger, SystemGeometrySymbol systemGeometrySymbol, Point2D location)
        ...
        public DisplaySystemSurfaceWaterExchanger(JsonObject jObject)
            : base(jObject)
        {
