...
{
    public class DisplaySystemDXCoil : SystemDXCoil, IDisplaySystemObject<SystemGeometryInstance>
    {
        ...
        public DisplaySystemDXCoil(SystemDXCoil systemDXCoil, SystemGeometrySymbol systemGeometrySymbol, Point2D location)
            :base(systemDXCoil)
        {
            systemGeometryInstance = new SystemGeometryInstance(systemGeometrySymbol, location);
        }

        public DisplaySystemDXCoil(DisplaySystemDXCoil displaySystemDXCoil)
            : base(displaySystemDXCoil)
        {
            systemGeometryInstance = displaySystemDXCoil?.systemGeometryInstance == null ? null : new SystemGeometryInstance(displaySystemDXCoil?.systemGeometryInstance);
        }

        public DisplaySystemDXCoil(Guid guid, DisplaySystemDXCoil displaySystemDXCoil)
            : base(guid, displaySystemDXCoil)
        {
            systemGeometryInstance = displaySystemDXCoil?.systemGeometryInstance == null ? null : new SystemGeometryInstance(displaySystemDXCoil?.systemGeometryInstance);
        }

        public DisplaySystemDXCoil(JsonObject jObject)
            : base(jObject)
        {
        ...
        {
            return new DisplaySystemDXCoil(guid == null ? Guid.NewGuid() : guid.Value, this);
        }
    }
}
