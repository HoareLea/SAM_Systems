...
namespace SAM.Analytical.Systems
{
    public class DisplaySystemSprayHumidifier : SystemSprayHumidifier, IDisplaySystemObject<SystemGeometryInstance>
    {
        ...
        public DisplaySystemSprayHumidifier(System.Guid guid, DisplaySystemSprayHumidifier displaySystemSprayHumidifier)
            : base(guid, displaySystemSprayHumidifier)
        {
            systemGeometryInstance = displaySystemSprayHumidifier?.systemGeometryInstance == null ? null : new SystemGeometryInstance(displaySystemSprayHumidifier?.systemGeometryInstance);
        }

        public DisplaySystemSprayHumidifier(JsonObject jObject)
            : base(jObject)
        {
        ...
        {
            return new DisplaySystemSprayHumidifier(guid == null ? Guid.NewGuid() : guid.Value, this);
        }
    }
}
