...
{
    public class DisplaySystemDirectEvaporativeCooler : SystemDirectEvaporativeCooler, IDisplaySystemObject<SystemGeometryInstance>
    {
        ...
        public DisplaySystemDirectEvaporativeCooler(SystemDirectEvaporativeCooler systemDirectEvaporativeCooler, SystemGeometrySymbol systemGeometrySymbol, Point2D location)
