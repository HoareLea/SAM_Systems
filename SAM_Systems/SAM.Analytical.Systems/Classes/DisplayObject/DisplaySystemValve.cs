...
{
    public class DisplaySystemValve : SystemValve, IDisplaySystemObject<SystemGeometryInstance>
    {
        ...
        public DisplaySystemValve(SystemValve systemValve, SystemGeometrySymbol systemGeometrySymbol, Point2D location)
            : base(systemValve)
        {
        ...
        public DisplaySystemValve(JsonObject jObject)
            : base(jObject)
        {
