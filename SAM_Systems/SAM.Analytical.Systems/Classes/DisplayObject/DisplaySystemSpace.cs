...
namespace SAM.Analytical.Systems
{
    public class DisplaySystemSpace : SystemSpace, IDisplaySystemObject<SystemGeometryInstance>
    {
        ...
        public DisplaySystemSpace(System.Guid guid, DisplaySystemSpace displaySystemSpace)
            : base(guid, displaySystemSpace)
        {
            systemGeometryInstance = displaySystemSpace?.systemGeometryInstance == null ? null : new SystemGeometryInstance(displaySystemSpace?.systemGeometryInstance);
        }

        public DisplaySystemSpace(JsonObject jObject)
            : base(jObject)
        {
        ...
        {
            return new DisplaySystemSpace(guid == null ? Guid.NewGuid() : guid.Value, this);
        }
    }
}
