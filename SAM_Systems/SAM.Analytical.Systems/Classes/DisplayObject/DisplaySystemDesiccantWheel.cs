...
{
    public class DisplaySystemDesiccantWheel : SystemDesiccantWheel, IDisplaySystemObject<SystemGeometryInstance>
    {
        ...
        public DisplaySystemDesiccantWheel(JsonObject jObject)
            : base(jObject)
        {
