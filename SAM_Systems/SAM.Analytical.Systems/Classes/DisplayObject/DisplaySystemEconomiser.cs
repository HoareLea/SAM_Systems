...
namespace SAM.Analytical.Systems
{
    public class DisplaySystemEconomiser : SystemEconomiser, IDisplaySystemObject<SystemGeometryInstance>
    {
        ...
        public DisplaySystemEconomiser(System.Guid guid, DisplaySystemEconomiser displaySystemEconomiser)
            : base(guid, displaySystemEconomiser)
        {
            systemGeometryInstance = displaySystemEconomiser?.systemGeometryInstance == null ? null : new SystemGeometryInstance(displaySystemEconomiser?.systemGeometryInstance);
        }

        public DisplaySystemEconomiser(JsonObject jObject)
            : base(jObject)
        {
        ...
        {
            return new DisplaySystemEconomiser(guid == null ? Guid.NewGuid() : guid.Value, this);
        }
    }
}
