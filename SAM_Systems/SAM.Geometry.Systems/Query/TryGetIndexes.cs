...
namespace SAM.Geometry.Systems
{
    public static partial class Query
    {
        ...
        public static bool TryGetIndexes(this SystemPlantRoom systemPlantRoom, ISystemComponent systemComponent_1, int connectionIndex_1, ISystemComponent systemComponent_2, int connectionIndex_2, out int index_1, out int index_2, SystemType systemType, Direction direction)
        {
            index_1 = -1;
            index_2 = -1;
            ...
            HashSet<int> indexes_1 = Core.Systems.Query.FindIndexes(systemPlantRoom, systemComponent_1, connectionIndex_1, systemType, ConnectorStatus.Unconnected, direction);
            if (indexes_1 == null || indexes_1.Count == 0)
            {
                if (systemComponent_1 is ISystemJunction)
                {
                    indexes_1 = Core.Systems.Query.FindIndexes(systemPlantRoom, systemComponent_1, connectionIndex_1, systemType, ConnectorStatus.Undefined, direction);
                }

                if (indexes_1 == null || indexes_1.Count == 0)
                {
                    indexes_1 = Core.Systems.Query.FindIndexes(systemPlantRoom, systemComponent_1, systemType, ConnectorStatus.Unconnected, direction);
                    if (indexes_1 == null || indexes_1.Count == 0)
                    {
                        if (systemComponent_1 is ISystemJunction)
                        {
            ...
            HashSet<int> indexes_2 = Core.Systems.Query.FindIndexes(systemPlantRoom, systemComponent_2, connectionIndex_2, systemType, ConnectorStatus.Unconnected, direction.Opposite());
            if (indexes_2 == null || indexes_2.Count == 0)
            {
                if (systemComponent_2 is ISystemJunction)
                {
                    indexes_2 = Core.Systems.Query.FindIndexes(systemPlantRoom, systemComponent_2, connectionIndex_2, systemType, ConnectorStatus.Undefined, direction.Opposite());
                }

                indexes_2 = Core.Systems.Query.FindIndexes(systemPlantRoom, systemComponent_2, systemType, ConnectorStatus.Unconnected, direction.Opposite());
                if (indexes_2 == null || indexes_2.Count == 0)
                {
                    if (systemComponent_2 is ISystemJunction)
                    {
